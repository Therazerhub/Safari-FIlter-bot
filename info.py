...
DATABASE_NAME = environ.get('DATABASE_NAME', "ySypMfTFQpuoUEHk")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+nAmW2gwVIYc2YTFl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/KH_NEW_MOVIES_PROVIDER')
...
# Streaming
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1001990451388")
...
URL = "https://{https://harsh0077h-67ac925272f2.herokuapp.com/}/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://{https://harsh0077h-67ac925272f2.herokuapp.com/}:{8080}/".format(FQDN, PORT)
